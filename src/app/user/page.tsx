    ...
    return (
      <section className="section-y">
        <div className="container-page">
          <p className="text-sm text-ocean-600 dark:text-ocean-400">Loading citizen portal…</p>
        </div>
      </section>
    );
  }
        ...
        <div className="flex flex-wrap items-start justify-between gap-4 border-b border-ocean-100 pb-6 dark:border-ocean-800">
          <div>
            ...
            <p className="mt-1 font-mono text-xs text-ocean-600 dark:text-ocean-400">
              Account: {session.email} · Dedicated route: <code className="text-ocean-900 dark:text-white">/user</code>
            </p>
          </div>
