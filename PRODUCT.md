...
- **No media pipeline yet.** Image uploads (would-be Cloudinary integration) were never wired up; Gallery and Success Stories intentionally show empty/placeholder states rather than fabricated images.
- **All current content is placeholder.** Partner names, donation figures, survey reports, testimonials, and blog posts are illustrative, not real organizational data — every one should be treated as replaceable, not evidence of real activity.
